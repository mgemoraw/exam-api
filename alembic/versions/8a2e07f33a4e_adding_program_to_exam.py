...
Revision ID: 8a2e07f33a4e
Revises: 3ed31bdf6235
Create Date: 2026-03-01 14:47:16.736466
...
revision: str = '8a2e07f33a4e'
down_revision: Union[str, Sequence[str], None] = '3ed31bdf6235'
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['created_by'], ['users.id'], ),
    sa.ForeignKeyConstraint(['program_id'], ['programes.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('mname', sa.String(length=100), nullable=False),
    ...
    sa.ForeignKeyConstraint(['student_id'], ['students.enrollment_number'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id')
    )
    ...
    sa.Column('is_correct', sa.Boolean(), nullable=True),
    sa.ForeignKeyConstraint(['attempt_id'], ['exam_attempt.id'], ),
    sa.ForeignKeyConstraint(['attempt_question_id'], ['attempt_question.id'], ),
    sa.ForeignKeyConstraint(['question_id'], ['questions.id'], ),
